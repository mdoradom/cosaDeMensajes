...
public final class FragmentPostsBinding implements ViewBinding {
  ...
  private FragmentPostsBinding(@NonNull FrameLayout rootView, @NonNull FloatingActionButton fab,
  ...
  public static FragmentPostsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPostsBinding((FrameLayout) rootView, fab, postsRecyclerView);
    }
